...
export default function Home() {
  ...
  return (
    <main className="w-screen h-screen">
      <div className="w-screen h-16 bg-transparent flex items-center text-white sticky z-10">
  ...
  {["home", "My skills", "contact"].map((item, index) => (
    ...
    >
      ...
      <video autoPlay loop muted className="absolute inset-0 w-full h-fit object-cover hue-rotate-180 ">
      ...
      <div className="w-screen h-[500px]  flex flex-row justify-start item-center overflow-hidden " id="box1">
        <h3  className="text-[400px] w-fit h-fit  text-center bg-clip-text text-transparent font-serif whitespace-nowrap bg-gradient-to-b from-pink-600 to-violet-600">
        𝓦𝓔𝓛𝓒𝓞𝓜𝓔 𝓣𝓞 𝓜𝓨 𝓟𝓞𝓡𝓣𝓕𝓞𝓛𝓘𝓞
        </h3>
      </div>

      <div className="w-screen h-fit pb-10">
        <h1 className="text-3xl translate-x-24 translate-y-24 font-merienda" id="skills">My Skills: </h1>
       <h2 className="text-yellow-300 translate-x-24 translate-y-32 font-bold text-8xl transition-transform duration-500 hover:scale-110 underline underline-offset-8 decoration-green-400 ">Frontend</h2>
        ...
        <h2 className="text-green-300 translate-x-24 translate-y-32 font-bold text-8xl transition-transform duration-500 hover:scale-110  underline underline-offset-8 decoration-red-500">Backend</h2>
...
<div className="pb-10">h</div>

<section id="contact" className="py-12 flex justify-center items-center bg-white">
  <Image src="/dribbble_3x-removebg-preview.png" width={600} height={700} className="-mt-14 ml-10" unoptimized alt="hero"/>
            ...
            <div className="bg-slate-900 shadow-2xl rounded-lg border-2 border-solid border-green-600 ml-32  p-5 w-3/4 shadow-green-600">
                ...
                <form id="contactForm" action="#" method="POST" className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="sm:col-span-2">
                        <label for="subject" className="block text-white font-semibold mb-2">Subject</label>
